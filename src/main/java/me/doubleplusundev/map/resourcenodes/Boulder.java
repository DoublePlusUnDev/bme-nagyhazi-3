...
public class Boulder extends ResourceNode {
    public Boulder(int xPos, int yPos, GameMap gameMap, ResourceManager resourceManager, UpdateManager updateManager) {
        super(xPos, yPos, ResourceNodeType.BOULDER, gameMap, resourceManager, updateManager);
