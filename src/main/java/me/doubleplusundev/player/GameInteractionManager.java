...
public class GameInteractionManager extends MouseAdapter{
    ...
    public GameInteractionManager(GameMapHandler gameMapHandler, PlayerController playerController, ResourceManager resourceManager) {
    ...
    public void mouseClicked(MouseEvent event) {
        ...
        if (playerController.getInteractionMode() == PlayerController.PlayerInteractionMode.BUILD)
            gameMapHandler.tryBuildStructure(x, y, playerController.getSelectedBuilding(), resourceManager);
        else
